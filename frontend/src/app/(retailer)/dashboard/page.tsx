      ...
      <div className="mb-8 flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-gray-500 font-medium flex items-center gap-2">
            ...
            Your store is currently tracking <span className="text-charcoal font-bold">{totalProducts} products</span>.
          </p>
        </div>
        <div className="flex items-center gap-3 px-4 py-2 bg-white rounded-xl border border-gray-100 text-sm font-bold text-gray-400">
